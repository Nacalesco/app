  ...
  theme: {
    extend: {
      colors: {
        ...
        exvia: {
          black: 'var(--exvia-black)',
          white: 'var(--exvia-white)',
          'base-black': 'var(--exvia-base-black)',
          subtle: 'var(--exvia-subtle)',
          border: 'var(--exvia-border)',
          violet: 'var(--exvia-violet)',
          'violet-light': 'var(--exvia-violet-light)',
          'violet-dark': 'var(--exvia-violet-dark)',
          focus: 'var(--exvia-focus)',
        },
      },
      fontFamily: {
