...
export function AnimatedButton({
  ...
  const baseStyles = cn(
    'relative overflow-hidden font-geist-mono inline-flex items-center justify-center gap-2 cursor-pointer',
  ...
  /** Smoothly scroll to a hash target */
  ...
  if (href) {
    ...
    return (
      <a
        ...
        onClick={isHash ? (e) => handleHashClick(e, href) : undefined}
